...
static time_t NGX_HTTP_PUSH_STREAM_DEFAULT_SHM_MEMORY_CLEANUP_OBJECTS_TTL = 15; // 15 seconds
static ngx_msec_t NGX_HTTP_PUSH_STREAM_SHM_MEMORY_CLEANUP_INTERVAL = 3000; // 3 seconds
